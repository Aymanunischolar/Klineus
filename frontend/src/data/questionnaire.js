export const DISCLAIMER = "AI-generated draft. Must be reviewed and approved by a physician.";
...
export const kneeTepBlocks = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "single",
        options: ["Weniger als 3 Monate", "3 bis 6 Monate", "6 bis 12 Monate", "Länger als 1 Jahr"],
      },
      {
        id: "A4",
      ...
      },
      {
        ...
        type: "multiple",
        options: ["Beim Gehen oder Belasten", "Beim Treppensteigen", "In Ruhe", "Nachts", "Eigentlich immer"],
      },
      {
        id: "A6",
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "single",
        options: ["Mehr als 1 Kilometer", "500 Meter bis 1 Kilometer", "100 bis 500 Meter", "Weniger als 100 Meter", "Kaum möglich"],
      },
      {
        id: "B5",
...
const blockTranslations = {
  A: { de: "Block A: Ihr Knieproblem", en: "Block A: Your knee problem" },
  B: { de: "Block B: Auswirkungen im Alltag", en: "Block B: Impact on daily life" },
  C: { de: "Block C: Bisherige Behandlung", en: "Block C: Previous treatment" },
  D: { de: "Block D: Vorbefunde und ärztliche Aussagen", en: "Block D: Previous findings and medical statements" },
  E: { de: "Block E: Gesundheit und Risiken", en: "Block E: Health and risks" },
  F: { de: "Block F: Ziele, Erwartungen und Ergänzungen", en: "Block F: Goals, expectations and additions" },
};

const questionTranslations = {
  A1: { de: "Um welches Knie geht es heute?", en: "Which knee is this about today?" },
  A2: { de: "Haben Sie aktuell Schmerzen in diesem Knie?", en: "Do you currently have pain in this knee?" },
  A3: { de: "Seit wann haben Sie diese Knieschmerzen?", en: "How long have you had this knee pain?" },
  A4: { de: "Wie stark sind Ihre Knieschmerzen im Durchschnitt?", en: "How strong is your knee pain on average?" },
  A5: { de: "Wann treten die Schmerzen vor allem auf?", en: "When does the pain mainly occur?" },
  A6: { de: "Was beschreibt Ihre Beschwerden am besten?", en: "What best describes your symptoms?" },
  A7: { de: "Was ist heute der Hauptgrund für Ihren Termin?", en: "What is the main reason for your appointment today?" },
  B1: {
  ...
  B5: { de: "Fühlt sich Ihr Knie manchmal instabil an oder knickt weg?", en: "Does your knee sometimes feel unstable or give way?" },
  B6: {
  ...
  B7: { de: "Haben Sie das Gefühl, dass Ihr Bein oder Knie schief steht?", en: "Do you feel that your leg or knee is misaligned?" },
  B8: { de: "Haben Sie das Gefühl, dass Ihr betroffenes Bein schwächer geworden ist?", en: "Do you feel that the affected leg has become weaker?" },
  B9: { de: "Brauchen Sie wegen Ihres Knies im Alltag Hilfe von anderen Personen?", en: "Do you need help from other people in daily life because of your knee?" },
  B10: { de: "Wie sehr leiden Sie persönlich unter Ihren Kniebeschwerden?", en: "How much do you personally suffer from your knee symptoms?" },
  C1: { de: "Wurden Ihre Kniebeschwerden schon behandelt?", en: "Have your knee symptoms already been treated?" },
  C2: { de: "Welche Behandlungen haben Sie bisher erhalten?", en: "Which treatments have you received so far?" },
  C3: { de: "Seit wie lange werden Ihre Kniebeschwerden schon behandelt?", en: "How long have your knee symptoms been treated?" },
  C4: { de: "Haben die bisherigen Behandlungen Ihre Beschwerden gebessert?", en: "Have previous treatments improved your symptoms?" },
  C5: {
  ...
  D1: { de: "Wurde von Ihrem Knie schon einmal ein Röntgenbild gemacht?", en: "Has an X-ray of your knee ever been taken?" },
  D2: {
  ...
  D5: { de: "Haben Sie Arztbriefe, Röntgenbilder oder Befunde zu Ihrem Knie?", en: "Do you have medical letters, X-rays or findings for your knee?" },
  D6: { de: "Wurde Ihnen bereits einmal eine Knieprothese empfohlen?", en: "Have you ever been recommended a knee replacement?" },
  E1: {
  ...
  E3: { de: "Haben Sie Diabetes oder erhöhte Blutzuckerwerte?", en: "Do you have diabetes or elevated blood sugar levels?" },
  E4: { de: "Wie groß sind Sie und wie viel wiegen Sie ungefähr?", en: "How tall are you and approximately how much do you weigh?" },
  E5: { de: "Rauchen Sie aktuell?", en: "Do you currently smoke?" },
  E6: { de: "Haben Sie in letzter Zeit eine Kortison-Spritze direkt ins Knie bekommen?", en: "Have you recently received a cortisone injection directly into the knee?" },
  E7: { de: "Wurde bei Ihnen schon einmal eine Blutarmut bzw. Anämie festgestellt?", en: "Have you ever been diagnosed with anemia?" },
  E8: { de: "Werden Sie aktuell wegen einer psychischen Erkrankung behandelt?", en: "Are you currently being treated for a mental health condition?" },
  E9: { de: "Haben Sie eine rheumatische Erkrankung?", en: "Do you have a rheumatic disease?" },
  E10: { de: "Nehmen Sie aktuell Kortison als Tabletten ein?", en: "Are you currently taking cortisone tablets?" },
  E11: {
  ...
  E13: { de: "Gab es früher schon einmal eine Infektion in diesem Knie?", en: "Has there ever been an infection in this knee before?" },
  E0: { de: "Wie alt sind Sie?", en: "How old are you?" },
  F1: { de: "Was möchten Sie durch die Behandlung Ihres Knies am meisten erreichen?", en: "What would you most like to achieve through treatment of your knee?" },
  F2: { de: "Welche Aktivität möchten Sie am liebsten wieder besser machen können?", en: "Which activity would you most like to be able to do better again?" },
  F3: { de: "Was wäre für Sie persönlich ein gutes Ergebnis der Behandlung?", en: "What would personally be a good treatment outcome for you?" },
  F4: { de: "Wurde mit Ihnen schon einmal über eine mögliche Knieoperation gesprochen?", en: "Has a possible knee operation ever been discussed with you?" },
  F5: { de: "Haben Sie Sorgen oder Fragen zu einer möglichen Operation?", en: "Do you have concerns or questions about a possible operation?" },
  F6: { de: "Gibt es noch etwas, das Ihr Arzt über Ihr Knie wissen sollte?", en: "Is there anything else your doctor should know about your knee?" },
};
...
const optionTranslations = {
  ...
  Ja: { de: "Ja", en: "Yes" },
  Nein: { de: "Nein", en: "No" },
  "Weniger als 3 Monate": { de: "Weniger als 3 Monate", en: "Less than 3 months" },
  "3 bis 6 Monate": { de: "3 bis 6 Monate", en: "3 to 6 months" },
  "6 bis 12 Monate": { de: "6 bis 12 Monate", en: "6 to 12 months" },
  "Länger als 1 Jahr": { de: "Länger als 1 Jahr", en: "More than 1 year" },
  "Beim Gehen oder Belasten": { de: "Beim Gehen oder Belasten", en: "When walking or bearing weight" },
  "Beim Treppensteigen": { de: "Beim Treppensteigen", en: "When climbing stairs" },
  "In Ruhe": { de: "In Ruhe", en: "At rest" },
  Nachts: { de: "Nachts", en: "At night" },
  "Eigentlich immer": { de: "Eigentlich immer", en: "Almost always" },
  Schmerz: { de: "Schmerz", en: "Pain" },
  Steifigkeit: { de: "Steifigkeit", en: "Stiffness" },
  "Unsicherheit im Knie": { de: "Unsicherheit im Knie", en: "Uncertainty in the knee" },
  "Das Knie knickt weg": { de: "Das Knie knickt weg", en: "The knee gives way" },
  "Knie lässt sich nicht richtig beugen oder strecken": {
  ...
  "Etwas anderes": { de: "Etwas anderes", en: "Something else" },
  "Ursache klären": { de: "Ursache klären", en: "Clarify the cause" },
  "Behandlung besprechen": { de: "Behandlung besprechen", en: "Discuss treatment" },
  "Prüfen ob eine Operation sinnvoll sein könnte": {
  ...
  "Längeres Stehen": { de: "Längeres Stehen", en: "Standing for longer periods" },
  "Hinsetzen oder Aufstehen": { de: "Hinsetzen oder Aufstehen", en: "Sitting down or standing up" },
  Knien: { de: "Knien", en: "Kneeling" },
  Körperpflege: { de: "Körperpflege", en: "Personal care" },
  Haushalt: { de: "Haushalt", en: "Household tasks" },
  "Arbeit oder Beruf": { de: "Arbeit oder Beruf", en: "Work or job" },
  "Sport oder Hobbys": { de: "Sport oder Hobbys", en: "Sports or hobbies" },
  "Bus, Bahn oder Auto nutzen": { de: "Bus, Bahn oder Auto nutzen", en: "Using bus, train or car" },
  "Soziale Aktivitäten": { de: "Soziale Aktivitäten", en: "Social activities" },
  "Keine besonderen Schwierigkeiten": { de: "Keine besonderen Schwierigkeiten", en: "No particular difficulties" },
  "Mehr als 1 Kilometer": { de: "Mehr als 1 Kilometer", en: "More than 1 kilometer" },
  "500 Meter bis 1 Kilometer": { de: "500 Meter bis 1 Kilometer", en: "500 meters to 1 kilometer" },
  "100 bis 500 Meter": { de: "100 bis 500 Meter", en: "100 to 500 meters" },
  "Weniger als 100 Meter": { de: "Weniger als 100 Meter", en: "Less than 100 meters" },
  "Kaum möglich": { de: "Kaum möglich", en: "Hardly possible" },
  Nie: { de: "Nie", en: "Never" },
  ...
  "Fast immer": { de: "Fast immer", en: "Almost always" },
  Schmerzmittel: { de: "Schmerzmittel", en: "Pain medication" },
  "Physiotherapie oder Krankengymnastik": { de: "Physiotherapie oder Krankengymnastik", en: "Physiotherapy" },
  "Übungen zu Hause": { de: "Übungen zu Hause", en: "Exercises at home" },
  "Spritzen ins Knie": { de: "Spritzen ins Knie", en: "Injections into the knee" },
  "Bandage oder Hilfsmittel": { de: "Bandage oder Hilfsmittel", en: "Brace or assistive device" },
  "Einlagen oder spezielle Schuhe": { de: "Einlagen oder spezielle Schuhe", en: "Insoles or special shoes" },
  "Empfehlung zur Gewichtsabnahme": { de: "Empfehlung zur Gewichtsabnahme", en: "Recommendation to lose weight" },
  "Sonstige Behandlung": { de: "Sonstige Behandlung", en: "Other treatment" },
  Keine: { de: "Keine", en: "None" },
  "Ja, deutlich": { de: "Ja, deutlich", en: "Yes, clearly" },
  "Ja, etwas": { de: "Ja, etwas", en: "Yes, somewhat" },
  "Nein, kaum oder gar nicht": { de: "Nein, kaum oder gar nicht", en: "No, hardly or not at all" },
  Teilweise: { de: "Teilweise", en: "Partly" },
  "Weiß ich nicht": { de: "Weiß ich nicht", en: "I don't know" },
  "Ja, ich habe Unterlagen": { de: "Ja, ich habe Unterlagen", en: "Yes, I have documents" },
  "Ich habe aufgehört": { de: "Ich habe aufgehört", en: "I have stopped" },
  "Ja, vor weniger als 6 Wochen": { de: "Ja, vor weniger als 6 Wochen", en: "Yes, less than 6 weeks ago" },
  "Ja, vor 6 Wochen bis 3 Monaten": {
    de: "Ja, vor 6 Wochen bis 3 Monaten",
    en: "Yes, 6 weeks to 3 months ago",
  },
  "Ja, vor mehr als 3 Monaten": { de: "Ja, vor mehr als 3 Monaten", en: "Yes, more than 3 months ago" },
  "Möchte ich nicht angeben": { de: "Möchte ich nicht angeben", en: "I prefer not to say" },
  "Ja, Herz": { de: "Ja, Herz", en: "Yes, heart" },
  "Ja, Lunge": { de: "Ja, Lunge", en: "Yes, lungs" },
  "Ja, Krebs": { de: "Ja, Krebs", en: "Yes, cancer" },
  "Ja, etwas anderes": { de: "Ja, etwas anderes", en: "Yes, something else" },
  "Weniger Schmerzen": { de: "Weniger Schmerzen", en: "Less pain" },
  "Besser gehen können": { de: "Besser gehen können", en: "Being able to walk better" },
  "Wieder besser Treppen steigen": { de: "Wieder besser Treppen steigen", en: "Climbing stairs better again" },
  "Wieder besser schlafen": { de: "Wieder besser schlafen", en: "Sleeping better again" },
  "Im Alltag unabhängiger sein": { de: "Im Alltag unabhängiger sein", en: "Being more independent in daily life" },
  "Wieder arbeiten können": { de: "Wieder arbeiten können", en: "Being able to work again" },
  "Wieder Sport oder Hobbys ausüben": { de: "Wieder Sport oder Hobbys ausüben", en: "Doing sports or hobbies again" },
  Vielleicht: { de: "Vielleicht", en: "Maybe" },
};

export function getBlockTitle(blockId, language = "de") {
  return blockTranslations[blockId]?.[language] || blockTranslations[blockId]?.de || blockId;
}

export function getQuestionText(questionOrId, language = "de", fallback = "") {
  if (typeof questionOrId === "object" && questionOrId.labels) {
    return questionOrId.labels[language] || questionOrId.labels.de || questionOrId.text || fallback;
  }

  const questionId = typeof questionOrId === "string" ? questionOrId : questionOrId.id;
  const fallbackText = typeof questionOrId === "string" ? fallback : questionOrId.text;
  return questionTranslations[questionId]?.[language] || questionTranslations[questionId]?.de || fallbackText;
}

export function getOptionLabel(option, language = "de") {
  if (option && typeof option === "object") {
    return option.labels?.[language] || option.labels?.de || option.value || "";
  }
...
export function getAnswerLabel(answer, language = "de", noAnswer = "keine Angabe") {
  if (Array.isArray(answer)) {
    return answer.length ? answer.map((item) => getOptionLabel(item, language)).join(", ") : noAnswer;
  }
...
export function normalizeAdminQuestion(question) {
  return {
    ...
    blockLabels: question.block_title || { de: question.block_id, en: question.block_id },
    type: question.type,
